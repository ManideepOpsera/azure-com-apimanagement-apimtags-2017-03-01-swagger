...
func Tagdescription_getHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateTagdescription_getTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_subscriptions_subscriptionId_resourceGroups_resourceGroupName_providers_Microsoft_ApiManagement_service_serviceName_apis_apiId_tagDescriptions_tagId",
	...
	return models.Tool{
		Definition: tool,
		Handler:    Tagdescription_getHandler(cfg),
	}
}
