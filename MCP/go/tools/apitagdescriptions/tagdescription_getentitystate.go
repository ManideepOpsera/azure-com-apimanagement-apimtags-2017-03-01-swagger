...
func Tagdescription_getentitystateHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateTagdescription_getentitystateTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("head_subscriptions_subscriptionId_resourceGroups_resourceGroupName_providers_Microsoft_ApiManagement_service_serviceName_apis_apiId_tagDescriptions_tagId",
	...
	return models.Tool{
		Definition: tool,
		Handler:    Tagdescription_getentitystateHandler(cfg),
	}
}
