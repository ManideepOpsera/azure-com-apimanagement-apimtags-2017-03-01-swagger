...
func Tagdescription_deleteHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateTagdescription_deleteTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_subscriptions_subscriptionId_resourceGroups_resourceGroupName_providers_Microsoft_ApiManagement_service_serviceName_apis_apiId_tagDescriptions_tagId",
		mcp.WithDescription("Delete tag description for the Api."),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Tagdescription_deleteHandler(cfg),
	}
}
