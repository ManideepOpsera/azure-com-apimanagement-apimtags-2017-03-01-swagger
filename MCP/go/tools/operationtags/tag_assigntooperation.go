...
func Tag_assigntooperationHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateTag_assigntooperationTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("put_subscriptions_subscriptionId_resourceGroups_resourceGroupName_providers_Microsoft_ApiManagement_service_serviceName_apis_apiId_operations_operationId_tags_tagId",
		mcp.WithDescription("Assign tag to the Operation."),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Tag_assigntooperationHandler(cfg),
	}
}
