...
func Tag_getentitystatebyoperationHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateTag_getentitystatebyoperationTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("head_subscriptions_subscriptionId_resourceGroups_resourceGroupName_providers_Microsoft_ApiManagement_service_serviceName_apis_apiId_operations_operationId_tags_tagId",
		mcp.WithDescription("Gets the entity state version of the tag specified by its identifier."),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Tag_getentitystatebyoperationHandler(cfg),
	}
}
