...
func Tag_listbyoperationHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/subscriptions/%s/resourceGroups/%s/providers/Microsoft.ApiManagement/service/%s/apis/%s/operations/%s/tags%s", cfg.BaseURL, resourceGroupName, serviceName, apiId, operationId, subscriptionId, queryString)
		...
		var result models.TagCollection
...
func CreateTag_listbyoperationTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_subscriptions_subscriptionId_resourceGroups_resourceGroupName_providers_Microsoft_ApiManagement_service_serviceName_apis_apiId_operations_operationId_tags",
		mcp.WithDescription("Lists all Tags associated with the Operation."),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Tag_listbyoperationHandler(cfg),
	}
}
