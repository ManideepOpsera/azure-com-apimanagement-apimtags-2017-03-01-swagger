...
func Tag_getentitystatebyapiHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateTag_getentitystatebyapiTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("head_subscriptions_subscriptionId_resourceGroups_resourceGroupName_providers_Microsoft_ApiManagement_service_serviceName_apis_apiId_tags_tagId",
	...
	return models.Tool{
		Definition: tool,
		Handler:    Tag_getentitystatebyapiHandler(cfg),
	}
}
