...
func Operation_listbytagsHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/subscriptions/%s/resourceGroups/%s/providers/Microsoft.ApiManagement/service/%s/apis/%s/operationsByTags%s", cfg.BaseURL, resourceGroupName, serviceName, apiId, subscriptionId, queryString)
...
func CreateOperation_listbytagsTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_subscriptions_subscriptionId_resourceGroups_resourceGroupName_providers_Microsoft_ApiManagement_service_serviceName_apis_apiId_operationsByTags",
		mcp.WithDescription("Lists a collection of operations associated with tags."),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Operation_listbytagsHandler(cfg),
	}
}
